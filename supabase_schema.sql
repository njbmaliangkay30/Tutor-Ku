...
-- PLATFORM SETTINGS TABLE (For centralized bank and QRIS payment configs)
...
-- 1. Allow everyone (public & authenticated) to read settings
...
-- 2. Allow write access only to verified Admins
