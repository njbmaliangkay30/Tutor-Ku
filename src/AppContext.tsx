...
const updateFavicon = (theme: string) => {
  ...
  favicon.href = `data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'%3E%3Cstyle%3E@import url('https://fonts.googleapis.com/css2?family=Syne:wght@800&amp;display=swap'); .tk-text { font-family: 'Syne', system-ui, sans-serif; font-weight: 800; font-size: 55px; letter-spacing: -2px; }%3C/style%3E%3Crect width='100' height='100' rx='22' fill='${bgColor}'/%3E%3Ctext x='54' y='70' class='tk-text' fill='${shadowColor}' text-anchor='middle'%3Etk%3C/text%3E%3Ctext x='50' y='66' class='tk-text' fill='${textColor}' text-anchor='middle'%3Etk%3C/text%3E%3C/svg%3E`;
};
